...
public class PortalBCSCHealthConnectRegistryPage extends BasePage{
    ...
    public void loginAsBCSC() throws Exception {
        ...
        Thread.sleep(1000);
        input_username_bcsc_citizen_registration.sendKeys(Utils.getEnvConfigProperty("user_BCSC_card"));
        Thread.sleep(1000);
        input_password_bcsc_citizen_registration.sendKeys(Utils.getEnvConfigProperty("password_BCSC_card"));
        Thread.sleep(1000);
