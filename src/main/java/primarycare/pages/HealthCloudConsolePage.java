...
public class HealthCloudConsolePage extends BasePage {
    ...
    @FindBy(xpath = ".//flexipage-field[@data-field-id='RecordPrimary_Care_Network_cField']//slot[1]//slot[1]//slot[1]//slot[text()]")
    private WebElement primary_care_network_actual_field_value;
    private By primary_care_network_actual_field_value_1 = By.xpath(".//flexipage-field[@data-field-id='RecordPrimary_Care_Network_cField']//slot[1]//slot[1]//slot[1]//slot[text()]");
    ...
    @FindBy(xpath = "//slot[text() ='Current Practitioner Location: Richmond']")
    private WebElement case_comment_actual_field_value;
    private By case_comment_actual_field_value_1 = By.xpath("//slot[text() ='Current Practitioner Location: Richmond']");

    @FindBy(xpath = "(//slot[text() ='Sandy Prior'])[2]")
    private WebElement caller_name_Sandy_Prior_2_actual_field_value;
    private By caller_name_Sandy_Prior_2_actual_field_value_1 = By.xpath("(//slot[text() ='Sandy Prior'])[2]");
