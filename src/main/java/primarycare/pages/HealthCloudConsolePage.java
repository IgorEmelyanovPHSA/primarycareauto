...
public class HealthCloudConsolePage extends BasePage {
    ...
    private By contact_name_actual_field_value_1 = By.xpath("(//span[text() ='Sandy Prior'])[2]");

    @FindBy(xpath = "(//span[text() ='Kenton Troup'])[2]")
    private WebElement contact_name_Attached_actual_field_value;
    private By contact_name_Attached_actual_field_value_1 = By.xpath("(//span[text() ='Kenton Troup'])[2]");
    ...
    @FindBy(xpath = ".//th[@data-label='Contact']//span//a[@title='SELENIUM Social']//slot[text()]")
    private WebElement caller_name_actual_field_value;
    private By caller_name_actual_field_value_1 = By.xpath(".//th[@data-label='Contact']//span//a[@title='SELENIUM Social']//slot[text()]");
    ...
    @FindBy(xpath = ".//th[@data-label='Contact']//span//a[@title='Igor PrimaryContactName']//slot[text()]")
    private WebElement primary_contact_name_actual_field_value;
    private By primary_contact_name_actual_field_value_1 = By.xpath(".//th[@data-label='Contact']//span//a[@title='Igor PrimaryContactName']//slot[text()]");
    ...
    @FindBy(xpath = ".//td[@data-label='Related Role']//span//a[@title='Social Worker']//slot[text()]")
    private WebElement caller_related_role_actual_field_value;
    private By caller_related_role_actual_field_value_1 = By.xpath(".//td[@data-label='Related Role']//span//a[@title='Social Worker']//slot[text()]");
    ...
    @FindBy(xpath = ".//td[@data-label='Related Role']//span//a[@title='Primary Contact']//slot[text()]")
    private WebElement primary_contact_related_role_actual_field_value;
    private By primary_contact_related_role_actual_field_value_1 = By.xpath(".//td[@data-label='Related Role']//span//a[@title='Primary Contact']//slot[text()]");
    ...
    @FindBy(xpath = "//tr[2]//th[@data-label='Contact']//span//a[@title='Sandy Prior']//slot[text()]")
    private WebElement caller_name_Sandy_Prior_2_actual_field_value;
    private By caller_name_Sandy_Prior_2_actual_field_value_1 = By.xpath("//tr[2]//th[@data-label='Contact']//span//a[@title='Sandy Prior']//slot[text()]");

    @FindBy(xpath = ".//td[@data-label='Related Role']//span//a[@title='Child']//slot[text()]")
    private WebElement caller_related_role_Child_actual_field_value;
    private By caller_related_role_Child_actual_field_value_1 = By.xpath(".//td[@data-label='Related Role']//span//a[@title='Child']//slot[text()]");

    @FindBy(xpath = "//tr[1]//th[@data-label='Contact']//span//a[@title='Sandy Prior']//slot[text()]")
    private WebElement primary_contact_name_Sandy_Prior_1_actual_field_value;
    private By primary_contact_name_Sandy_Prior_1_actual_field_value_1 = By.xpath("//tr[1]//th[@data-label='Contact']//span//a[@title='Sandy Prior']//slot[text()]");

    @FindBy(xpath = "(//span[text() ='Hollis Violette'])[2]")
    private WebElement contact_name_Attached_Hollis_Violette_actual_field_value;
    private By contact_name_Attached_actual_Hollis_Violette_field_value_1 = By.xpath("(//span[text() ='Hollis Violette'])[2]");
