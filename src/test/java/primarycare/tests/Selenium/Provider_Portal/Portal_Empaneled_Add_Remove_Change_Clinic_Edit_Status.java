...
public class Portal_Empaneled_Add_Remove_Change_Clinic_Edit_Status extends BaseTest_PrimaryCare {
    ...
    ///REFRESH
    public String patient__c = "001bZ000002oLpwQAE";////'BABY GIRL' "MUNCIE" <-- Prosacco "Garth"
    public String healthcare_facility_network__c = "0bYbZ0000000uoxUAA";//"Karen Beegan | Panel | NORTH SHORE PRIMARY CARE MED HOME" from "HealthcareFacilityNetwork"
    ///REFRESH
