...
public class Portal_Empaneled_Add_Remove_Change_Clinic_Edit_Status extends BaseTest_PrimaryCare {
    ...
    ///REFRESH
    public String patient__c = "001Aq00000KoaSwIAJ";////Prosacco Garth ID - the same as Patient_ID__c in Account.
    public String healthcare_facility_network__c = "0bYAq0000002EtLMAU";//Lori-Ann Bus | Panel | CASTLEGAR MED FAMILY CLINIC
    ///REFRESH
