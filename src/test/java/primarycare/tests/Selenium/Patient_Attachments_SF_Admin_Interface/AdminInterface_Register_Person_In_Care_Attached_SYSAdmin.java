...
public class AdminInterface_Register_Person_In_Care_Attached_SYSAdmin extends BaseTest_PrimaryCare {
    ...
    private String streetAddress = "501-6609 Goodmere Road";//"309-7631 Francis Rd";
    ...
    private String cityOrTown = "Sooke";//"Richmond";
    ...
    private String primaryCareNetworkExpected = "Western Communities";//"Richmond - West";
    ...
    public void Can_Register_Person_In_Care_for_Attached_in_SF_AdminInterface_as_an_SYSAdmin () throws Exception {
        ...
        log("/*49.---- Validate Account name - '4124 Sooke'  ---*/");
        ...
        log("/*50.---- Validate Primary Care Network - 'Western Communities'  ---*/");
        ...
        log("/*51.---- Validate Case Reason - 'Family doctor or nurse practitioner is not accepting additional family members'  ---*/");
        ...
        log("/*54.----all broken with DHSOPR-4795 - Validate Case Comments - 'Current Practitioner Location: Sooke,'  ---*/");
