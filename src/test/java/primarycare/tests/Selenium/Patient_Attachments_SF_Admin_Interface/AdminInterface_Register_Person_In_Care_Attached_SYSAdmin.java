...
public class AdminInterface_Register_Person_In_Care_Attached_SYSAdmin extends BaseTest_PrimaryCare {
    ...
    public void Can_Register_Person_In_Care_for_Attached_in_SF_AdminInterface_as_an_SYSAdmin () throws Exception {
        ...
        log("/*51.---- Validate Account name - '4124 Sooke'  ---*/");
        ...
        log("/*52.---- Validate Primary Care Network - 'Western Communities'  ---*/");
        ...
        log("/*53.---- Validate Case Reason - 'Family doctor or nurse practitioner is not accepting additional family members'  ---*/");
        ...
        log("/*56.----all broken with DHSOPR-4795 - Validate Case Comments - 'Current Practitioner Location: Sooke,'  ---*/");
