...
public class API_Empaneled_Patients_SysAdmin extends API_BaseTest_PrimaryCare{
    ...
    //for Test 3.insert
    ///REFRESH
    public String patient__c = "001bZ000004x6q9QAA";//'BABY GIRL' 'MUNCIE' <-- Prosacco Garth - the same as Patient_ID__c in Account.
    public String healthcare_facility_network__c = "0bYbZ000000269PUAQ";//Lori-Ann Bus | Panel | CASTLEGAR MED FAMILY CLINIC
    ///REFRESH
