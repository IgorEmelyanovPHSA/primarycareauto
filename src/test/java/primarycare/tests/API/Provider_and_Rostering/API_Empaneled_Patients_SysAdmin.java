...
public class API_Empaneled_Patients_SysAdmin extends API_BaseTest_PrimaryCare{
    //for Test 1.-select
    private String empaneledPatientPHN = "9876923304"; //'BABY GIRL' "MUNCIE" <--Mariano Brakus
    public String empaneledId;

    //for Test 3.insert
    ///REFRESH
    public String patient__c = "001G100000GjcWQIAZ";//'BABY GIRL' 'MUNCIE' ID <--Mariano Brakus ID - the same as Patient_ID__c in Account.
    public String healthcare_facility_network__c = "0bYG1000000006pMAA";//Karen Beegan | Panel | NORTH SHORE PRIMARY CARE MED HOME" - the same as Id from "HealthcareFacilityNetwork"
    ///REFRESH
    ...
    public void API_Can_Select_EmpaneledID_From_Panel_Member__c_Salesforce_Status_Code_200_as_SysAdmin(){
        ...
        log("Selected Empaneled Patient  'BABY GIRL' 'MUNCIE' record Id from 'Panel_Member__c' is: " +empaneledPatientRecordID);
    ...
    public void API_Can_Remove_Empaneled_Patient_Record_in_Salesforce_Status_Code_204_as_SysAdmin(){
        ...
        if(empaneledId==null){
            log("No Empaneled Patients records for  'BABY GIRL' 'MUNCIE'.");
            log("Nothings to delete - do nothing.");
        }
        else {
            log("Empaneled Patients records for  'BABY GIRL' 'MUNCIE' has founded.");
            log("lets Delete it");
            ...
            log(apiResponse);
            log("Status Code 204 - Empaneled Patient  'BABY GIRL' 'MUNCIE' Deleted - successfully");
        }
    }
    ...
    public void API_Can_Create_EMPANELED_Record_In_Salesforce_Status_Code_201_as_SysAdmin(){
        ...
        log("Status Code 201 - Empaneled record  'BABY GIRL' 'MUNCIE' created success");
    }
