...
public class API_Registering_Primary_Care_Attached_Patient_SYSAdmin extends API_BaseTest_PrimaryCare {
    ...
    ////REFRESH
    public String healthCloudGA__Role__c = "a16bZ00000017KfQAI"; //"Primary Contact" record role ->Contact Relation Name role from 'HealthCloudGA__ContactContactRelation__c' Object
    ////REFRESH
    ...
    ////REFRESH
    public String caseAccountId = "001bZ000003FOF4QAO"; //"3113 Broadmoor";
    public String casePrimaryCareNetwork__c = "001bZ000003FA6oQAG"; //"Richmond - East";
    ////REFRESH
    ...
    ////REFRESH
    public String practitionerAttached__c = "001bZ000003FPZIQA4";//from "Case" Lori-Ann May Bus
    ...
    ////REFRESH
    public String practitionerContactId = "003bZ000003RW7AQAW";//from "CaseContactRole" ContactId Lori-Ann May Bus
    ////REFRESH
