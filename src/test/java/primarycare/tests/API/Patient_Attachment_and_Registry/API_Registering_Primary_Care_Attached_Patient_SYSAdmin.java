...
public class API_Registering_Primary_Care_Attached_Patient_SYSAdmin extends API_BaseTest_PrimaryCare {
    ...
    ////REFRESH
    public String healthCloudGA__Role__c = "a16As000000oU81IAE"; //"Primary Contact" record role ->Contact Relation Name role from 'HealthCloudGA__ContactContactRelation__c' Object
    ////REFRESH
    ...
    ////REFRESH
    public String caseAccountId = "001As00000SEvOgIAL"; //"3113 Broadmoor";
    public String casePrimaryCareNetwork__c = "001As00000SEvMcIAL"; //"Richmond - East";
    ////REFRESH
    ...
    ////REFRESH
    public String practitionerAttached__c = "001As00000SEwdVIAT";//from "Case" Lori-Ann May Bus
    ...
    ////REFRESH
    public String practitionerContactId = "003As00000OQEWyIAP";//from "CaseContactRole" ContactId Lori-Ann May Bus
    ////REFRESH
