...
public class API_Registering_Primary_Care_Attached_Patient_SYSAdmin extends API_BaseTest_PrimaryCare {
    ...
    ////REFRESH
    public String contactRecord_healthCloudGA__sourceSystem__c = "Health1-00DAs000002zyxN"; //from Account
    public String contactRecord_healthCloudGA__sourceSystem__pc = "Health1-00DAs000002zyxN";
    ////REFRESH
    ...
    ////REFRESH
    public String healthCloudGA__Role__c = "a16As000000Mo3FIAS"; //"Primary Contact" record role ->Contact Relation Name role from 'HealthCloudGA__ContactContactRelation__c' Object
    ////REFRESH
    ...
    ////REFRESH
    public String practitionerAttached__c = "001As00000KSwUjIAL";//from "Case" Lori-Ann May Bus
    ...
    ////REFRESH
    public String practitionerContactId = "003As00000GTexrIAD";//from "CaseContactRole" ContactId Lori-Ann May Bus
    ////REFRESH
