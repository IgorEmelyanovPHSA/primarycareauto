...
public class API_Registering_Primary_Care_Attached_Patient_SYSAdmin extends API_BaseTest_PrimaryCare {
    ...
    ////REFRESH
    public String healthCloudGA__Role__c = "a16bZ00000016GXQAY"; //"Primary Contact" record role ->Contact Relation Name role from 'HealthCloudGA__ContactContactRelation__c' Object
    ////REFRESH
    ...
    ////REFRESH
    public String caseAccountId = "001bZ000003DZkTQAW"; //"4124 Sooke";
    public String casePrimaryCareNetwork__c = "001bZ000003DZgwQAG"; //"Western Communities";
    ////REFRESH
    ...
    ////REFRESH
    public String practitionerAttached__c = "001bZ000003Dc2oQAC";// from "Case" Lori-Ann May Bus
    ////REFRESH
    ...
    ////REFRESH
    public String practitionerContactId = "003bZ000003Pc7CQAS";// from "CaseContactRole" ContactId Lori-Ann May Bus
    ////REFRESH
