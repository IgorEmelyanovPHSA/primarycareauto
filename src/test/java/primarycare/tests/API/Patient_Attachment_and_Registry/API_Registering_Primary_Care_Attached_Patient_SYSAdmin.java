...
public class API_Registering_Primary_Care_Attached_Patient_SYSAdmin extends API_BaseTest_PrimaryCare {
    ...
    ////REFRESH
    public String healthCloudGA__Role__c = "a16bZ0000001z80QAA"; //"Primary Contact" record role ->Contact Relation Name role from 'HealthCloudGA__ContactContactRelation__c' Object
    ////REFRESH
    ...
    ////REFRESH
    public String caseAccountId = "001bZ000004x5qgQAA"; //"3113 Broadmoor";
    public String casePrimaryCareNetwork__c = "001bZ000004x5tCQAQ"; //"Richmond - East";
    ////REFRESH
    ...
    ////REFRESH
    public String practitionerAttached__c = "001bZ000004x7ZJQAY";//from "Case" Lori-Ann May Bus
    ...
    ////REFRESH
    public String practitionerContactId = "003bZ000005UOGPQA4";//from "CaseContactRole" ContactId Lori-Ann May Bus
    ////REFRESH
