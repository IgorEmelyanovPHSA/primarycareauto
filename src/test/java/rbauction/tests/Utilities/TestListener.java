...
public class TestListener extends BaseTest_RBAuction implements ITestListener {
    ...
    public void onTestFailure(ITestResult iTestResult) {
        ...
        WebDriver driver = ((BaseTest_RBAuction) testClass).getDriver();
        ByteArrayOutputStream output = ((BaseTest_RBAuction) testClass).getLogOutputSteps();
